...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="faq-item">
            ...
            <div class="faq-a"><?= $is_en ? $f['a_en'] : $f['a_es'] ?></div>
        </div>
        <?php endforeach; ?>
    </div>
